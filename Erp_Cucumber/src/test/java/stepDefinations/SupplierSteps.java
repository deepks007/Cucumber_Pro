...
public class SupplierSteps {
	...
	@When("Capture for supplier number with {string} and {string}")
	public void capture_for_supplier_number_with_and(String Locator_Type, String Locator_Value) throws Throwable {
